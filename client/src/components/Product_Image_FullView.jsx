...
<div className="modal fade" id="imageModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div className="carousel-inner">
    ...
    <img src={`http://localhost:3000/${image}`} className="d-block w-100" style={{cursor:'pointer', imageRendering:'pixelated', height:'268px'}} alt="..." loading='lazy' data-bs-toggle="modal" data-bs-target="#imageModal"/>
        </div>
    ))}
  </div>
